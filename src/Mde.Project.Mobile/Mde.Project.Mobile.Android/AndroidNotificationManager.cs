...
namespace Mde.Project.Mobile.Droid
{
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        public void SendNotification(string title, string message, string firstTriggerTime, string intervalTime)
        {
            ...
            if (intervalTime != null)
            {
                ...
                PendingIntent pendingIntent = PendingIntent.GetBroadcast(AndroidApp.Context, pendingIntentId++, intent, PendingIntentFlags.UpdateCurrent | PendingIntentFlags.Immutable);
